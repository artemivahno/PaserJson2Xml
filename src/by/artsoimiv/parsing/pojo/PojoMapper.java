...
//Десериализует JsonObject или JsonArray в простые объекты Java, установив поля и вызывающие сеттеры на целевом объекте.
public class PojoMapper {
    private final List<PojoMappingRule> mappingRules;


//Преобразует аргумент JsonObject в объект указанного класса.
...
//Преобразует аргумент JsonArray в список объектов указанного класса.
...
//Попробуeт преобразовать аргумент в указанный класс.
...
//Попробуeт преобразовать аргумент JsonArray в список указанного класса.
